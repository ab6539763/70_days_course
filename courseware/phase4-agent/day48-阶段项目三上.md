...
| 选题 | 描述 | 技术栈 |
|------|------|--------|
| A. 智能研究助手 | 搜索+RAG+多Agent写作 | LangGraph+MCP |
| B. 企业知识管家 | 文档RAG+Agent问答 | LangChain+Dify |
| C. 数据分析Agent | SQL+图表+报告 | LangGraph+Tools |

#### 架构设计模板

```
用户 → 意图分类
  ├─ 知识问答 → RAG Pipeline (Day 38)
  └─ 复杂任务 → Agent Graph (Day 41-43)
       ├─ 工具调用
       ├─ 人工审核 (Day 42)
       └─ 结果汇总
```
...
参考架构搭建项目骨架，完成意图分类和 RAG 集成。下午专注 Agent 图的核心节点实现。
...
复习 Day 48 内容，阅读官方文档，完成课后作业。

### 20:00 - 21:00 | 自习答疑

- 完成今天的实操项目和课后作业
- 确保代码可运行并提交 GitHub
- Git 提交：`git commit -m "Day 48: 阶段项目三上"`
- 预习 Day 49 内容
...
*课程讲义 · 零基础大模型应用开发 70 天培训 · Day 48 · 第四阶段 Agent 开发*
...
回顾 Day 47 到 Day 48 的知识串联，绘制思维导图。将今天学的知识与前三阶段（Python、RAG、Agent）的知识点关联起来。
...
Day 48 是 Agent 开发阶段的重要一环。确保你能将今天的内容与 Day 39-43 的技术串联起来。
