...
- 本练习与 Day 2 的字符串清洗知识点预衔接。
- 建议将本练习保存为 `drill_6_1.py`，晚自习用 Git 提交。

**参考实现思路 #1**（课堂上由讲师演示，课后对照）：
...
**常见错误 #1**：中文标点符号、`print` 拼写错误、缩进使用了 Tab 与空格混用（企业项目统一 4 空格）。
...
- 每次修改一个点，立刻运行，形成「改一行 → 看结果」的节奏。
- 出错时阅读 Traceback 最后一行：`NameError` 多为拼写或未定义；`SyntaxError` 多为括号、引号不配对。
- 本练习与 Day 3 的字符串清洗知识点预衔接。
- 建议将本练习保存为 `drill_6_2.py`，晚自习用 Git 提交。

**参考实现思路 #2**（课堂上由讲师演示，课后对照）：
...
**常见错误 #2**：中文标点符号、`print` 拼写错误、缩进使用了 Tab 与空格混用（企业项目统一 4 空格）。
...
- 每次修改一个点，立刻运行，形成「改一行 → 看结果」的节奏。
- 出错时阅读 Traceback 最后一行：`NameError` 多为拼写或未定义；`SyntaxError` 多为括号、引号不配对。
- 本练习与 Day 4 的字符串清洗知识点预衔接。
- 建议将本练习保存为 `drill_6_3.py`，晚自习用 Git 提交。

**参考实现思路 #3**（课堂上由讲师演示，课后对照）：
...
**常见错误 #3**：中文标点符号、`print` 拼写错误、缩进使用了 Tab 与空格混用（企业项目统一 4 空格）。
...
- 每次修改一个点，立刻运行，形成「改一行 → 看结果」的节奏。
- 出错时阅读 Traceback 最后一行：`NameError` 多为拼写或未定义；`SyntaxError` 多为括号、引号不配对。
- 本练习与 Day 5 的流程控制知识点预衔接。
- 建议将本练习保存为 `drill_6_4.py`，晚自习用 Git 提交。

**参考实现思路 #4**（课堂上由讲师演示，课后对照）：
...
**常见错误 #4**：中文标点符号、`print` 拼写错误、缩进使用了 Tab 与空格混用（企业项目统一 4 空格）。
...
- 每次修改一个点，立刻运行，形成「改一行 → 看结果」的节奏。
- 出错时阅读 Traceback 最后一行：`NameError` 多为拼写或未定义；`SyntaxError` 多为括号、引号不配对。
- 本练习与 Day 6 的流程控制知识点预衔接。
- 建议将本练习保存为 `drill_6_5.py`，晚自习用 Git 提交。

**参考实现思路 #5**（课堂上由讲师演示，课后对照）：
...
**常见错误 #5**：中文标点符号、`print` 拼写错误、缩进使用了 Tab 与空格混用（企业项目统一 4 空格）。
...
- 每次修改一个点，立刻运行，形成「改一行 → 看结果」的节奏。
- 出错时阅读 Traceback 最后一行：`NameError` 多为拼写或未定义；`SyntaxError` 多为括号、引号不配对。
- 本练习与 Day 7 的流程控制知识点预衔接。
- 建议将本练习保存为 `drill_6_6.py`，晚自习用 Git 提交。

**参考实现思路 #6**（课堂上由讲师演示，课后对照）：
...
**常见错误 #6**：中文标点符号、`print` 拼写错误、缩进使用了 Tab 与空格混用（企业项目统一 4 空格）。
...
- 每次修改一个点，立刻运行，形成「改一行 → 看结果」的节奏。
- 出错时阅读 Traceback 最后一行：`NameError` 多为拼写或未定义；`SyntaxError` 多为括号、引号不配对。
- 本练习与 Day 8 的数据结构知识点预衔接。
- 建议将本练习保存为 `drill_6_7.py`，晚自习用 Git 提交。

**参考实现思路 #7**（课堂上由讲师演示，课后对照）：
...
**常见错误 #7**：中文标点符号、`print` 拼写错误、缩进使用了 Tab 与空格混用（企业项目统一 4 空格）。
...
- 每次修改一个点，立刻运行，形成「改一行 → 看结果」的节奏。
- 出错时阅读 Traceback 最后一行：`NameError` 多为拼写或未定义；`SyntaxError` 多为括号、引号不配对。
- 本练习与 Day 9 的数据结构知识点预衔接。
- 建议将本练习保存为 `drill_6_8.py`，晚自习用 Git 提交。

**参考实现思路 #8**（课堂上由讲师演示，课后对照）：
...
**常见错误 #8**：中文标点符号、`print` 拼写错误、缩进使用了 Tab 与空格混用（企业项目统一 4 空格）。
...
- 每次修改一个点，立刻运行，形成「改一行 → 看结果」的节奏。
- 出错时阅读 Traceback 最后一行：`NameError` 多为拼写或未定义；`SyntaxError` 多为括号、引号不配对。
- 本练习与 Day 10 的数据结构知识点预衔接。
- 建议将本练习保存为 `drill_6_9.py`，晚自习用 Git 提交。

**参考实现思路 #9**（课堂上由讲师演示，课后对照）：
...
**常见错误 #9**：中文标点符号、`print` 拼写错误、缩进使用了 Tab 与空格混用（企业项目统一 4 空格）。
...
- 每次修改一个点，立刻运行，形成「改一行 → 看结果」的节奏。
- 出错时阅读 Traceback 最后一行：`NameError` 多为拼写或未定义；`SyntaxError` 多为括号、引号不配对。
- 本练习与 Day 11 的API 调用知识点预衔接。
- 建议将本练习保存为 `drill_6_10.py`，晚自习用 Git 提交。

**参考实现思路 #10**（课堂上由讲师演示，课后对照）：
...
**常见错误 #10**：中文标点符号、`print` 拼写错误、缩进使用了 Tab 与空格混用（企业项目统一 4 空格）。
...
- 每次修改一个点，立刻运行，形成「改一行 → 看结果」的节奏。
- 出错时阅读 Traceback 最后一行：`NameError` 多为拼写或未定义；`SyntaxError` 多为括号、引号不配对。
- 本练习与 Day 12 的API 调用知识点预衔接。
- 建议将本练习保存为 `drill_6_11.py`，晚自习用 Git 提交。

**参考实现思路 #11**（课堂上由讲师演示，课后对照）：
...
**常见错误 #11**：中文标点符号、`print` 拼写错误、缩进使用了 Tab 与空格混用（企业项目统一 4 空格）。
...
- 每次修改一个点，立刻运行，形成「改一行 → 看结果」的节奏。
- 出错时阅读 Traceback 最后一行：`NameError` 多为拼写或未定义；`SyntaxError` 多为括号、引号不配对。
- 本练习与 Day 13 的API 调用知识点预衔接。
- 建议将本练习保存为 `drill_6_12.py`，晚自习用 Git 提交。

**参考实现思路 #12**（课堂上由讲师演示，课后对照）：
...
**常见错误 #12**：中文标点符号、`print` 拼写错误、缩进使用了 Tab 与空格混用（企业项目统一 4 空格）。
...
**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 1）。

**原因分析**：第 1 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**预防**：建立「单职责小文件」习惯，错误定位更快。与 Day 11 工程化主题呼应。


### 问题 2：环境与语法常见坑 #2

**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 2）。

**原因分析**：第 2 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**预防**：建立「单职责小文件」习惯，错误定位更快。与 Day 12 工程化主题呼应。


### 问题 3：环境与语法常见坑 #3

**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 3）。

**原因分析**：第 3 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**预防**：建立「单职责小文件」习惯，错误定位更快。与 Day 13 工程化主题呼应。


### 问题 4：环境与语法常见坑 #4

**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 4）。

**原因分析**：第 4 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**预防**：建立「单职责小文件」习惯，错误定位更快。与 Day 14 工程化主题呼应。


### 问题 5：环境与语法常见坑 #5

**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 5）。

**原因分析**：第 5 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**预防**：建立「单职责小文件」习惯，错误定位更快。与 Day 10 工程化主题呼应。


### 问题 6：环境与语法常见坑 #6

**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 6）。

**原因分析**：第 6 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 7）。

**原因分析**：第 7 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 8）。

**原因分析**：第 8 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 9）。

**原因分析**：第 9 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 10）。

**原因分析**：第 10 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 11）。

**原因分析**：第 11 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 12）。

**原因分析**：第 12 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 13）。

**原因分析**：第 13 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 14）。

**原因分析**：第 14 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 15）。

**原因分析**：第 15 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 16）。

**原因分析**：第 16 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 17）。

**原因分析**：第 17 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 18）。

**原因分析**：第 18 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 19）。

**原因分析**：第 19 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
...
**现象**：运行 `python hello.py` 报错或输出不符合预期（场景 20）。

**原因分析**：第 20 类典型原因包括——未激活正确解释器、文件未保存、路径含中文空格、复制代码时缩进损坏、`if __name__` 拼写错误等。
